module XPath
  ...
  protected
    ...
    def locate_field(xpath, locator)
      locate_field = xpath[attr(:id).equals(locator) | attr(:name).equals(locator) | attr(:placeholder).contains(locator) | attr(:id).equals(anywhere(:label)[string.n.is(locator)].attr(:for))]
